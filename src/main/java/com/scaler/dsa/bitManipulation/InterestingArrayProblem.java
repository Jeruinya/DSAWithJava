...
Observation 1: if any element in the array is even than it can be made as 0->split element into two equal part Ai/2 and Ai/2 and XOR of the two equal elements are zero.
Observation 2: if any element is odd then we can split it into two parts 1 and Ai-1. Ai-1 is even that is an odd element can be reduce its size to 1.
