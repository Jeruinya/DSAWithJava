...
/*
Problem Description
Given a singly linked list A and an integer B, reverse the nodes of the list B at a 
time and return the modified linked list.
...
public class KReverseLL {
	...
	public static void main(String[] args) {
		...
		Node node = reverseList(head, 3);
		print(node);

	}

	public static Node reverseList(Node A, int k) {
		if (A == null)
			return null;
		Node current = A;
		Node next = null;
