package com.scaler.multithreading.multithreading.mergeSort;
...
public class MergeSorterTask implements Callable<List<Integer>> {
	...
	public MergeSorterTask(List<Integer> arrayToSort, ExecutorService executorService) {
	...
	public List<Integer> call() throws Exception {
		...
		Future<List<Integer>> leftSortedArrayFuture = executorService
				.submit(new MergeSorterTask(leftArrayToSort, executorService));

		Future<List<Integer>> rightSortedArrayFuture = executorService
				.submit(new MergeSorterTask(rightArrayToSort, executorService));
